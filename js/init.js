(function(w){
	var sw = document.body.clientWidth, //Viewport Width
		...
		$imgWidth=$('.img-size-width'),//Image Resolution width
		$imgHeight=$('.img-size-height'),//Image Resolution Height
	...
	$(w).resize(function(){ //Update dimensions on resize
		...
		if(hash>$("#zsg-vp-wrap").width()){
			hash=$("#zsg-vp-wrap").width();
		}
		sizeiframe(hash,false);
	...
	if(hash === 'hay') { 
		...
		sizeiframe(parseInt(hash),false);
	} else {
		sizeiframe(parseInt(hash),false);
	}	
	$("#dvcircle").mousedown(function(event){		
		// show the cover
